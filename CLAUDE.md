...
- **Project Name:** `Claude Learning`
- **Description:** `This project is to learn the ability to use claude code to develop`
...
│   │   │   └── Migrations/
│   │   └── Repositories/
│   └── [ProjectName].Web/           # Frontend Blazor Server with FluentUI-Blazor
│       ├── Pages/
│       └── Components/
└── tests/
...
- **Frontend:** Blazor Server with FluentUI-blazor V5 package
